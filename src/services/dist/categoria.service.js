...
var CategoriaService = /** @class */ (function () {
    ...
    CategoriaService.prototype.create = function (data) {
        return __awaiter(this, void 0, Promise, function () {
            var repositoryCategoria, categoriaExists, categoria;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repositoryCategoria = typeorm_1.getRepository(CategoriaEspecie_1.CategoriaEspecie);
                        return [4 /*yield*/, repositoryCategoria.findOne({ where: { nome: data.nome } })];
                    case 1:
                        categoriaExists = _a.sent();
                        if (categoriaExists) {
                            throw new Error('Já existe uma categoria cadastrada com este nome');
                        }
                        categoria = repositoryCategoria.create(data);
                        return [4 /*yield*/, categoria.save()];
                    case 2:
                        _a.sent();
    ...
    CategoriaService.prototype.update = function (id, data) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getRepository(CategoriaEspecie_1.CategoriaEspecie).update(id, data)];
                    case 1:
                        _a.sent();
    ...
    CategoriaService.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getRepository(CategoriaEspecie_1.CategoriaEspecie)["delete"](id)
    ...
    CategoriaService.prototype.search = function (q) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getRepository(CategoriaEspecie_1.CategoriaEspecie)
    ...
    CategoriaService.prototype.findById = function (id) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, typeorm_1.getRepository(CategoriaEspecie_1.CategoriaEspecie).findOne({ where: { id: id } })];
                    case 1:
                        categoria = _a.sent();
                        return [2 /*return*/, categoria];
                }
