...
var SysRefService = /** @class */ (function () {
    ...
    SysRefService.prototype.getAll = function (query) {
        return __awaiter(this, void 0, Promise, function () {
            var perPage, page, search, orderBy, order, skip, orderByTerm, searchTermFilter, orderByElement, _a, sysRefs, total;
            var _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, prismaClient_1.prismaClient.$transaction([
                                prismaClient_1.prismaClient.spatialRefSys.findMany({
                                    where: __assign({}, searchTermFilter),
                                    take: perPage ? parseInt(perPage) : 50,
                                    skip: skip ? skip : 0,
                                    orderBy: __assign({}, orderByTerm)
                                }),
                                prismaClient_1.prismaClient.spatialRefSys.count()
                            ])];
                    case 1:
                        _a = _d.sent(), sysRefs = _a[0], total = _a[1];
                        return [2 /*return*/, {
                                data: sysRefs,
                                perPage: perPage,
                                page: page,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prismaClient_1.prismaClient.spatialRefSys.findMany({
                            where: {
                                OR: [{ srtext: { mode: 'insensitive', contains: text } }]
                            },
                            orderBy: {
                                srtext: 'asc'
                            }
